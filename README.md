...
### Losing Sanity:
   - Being alone inside the facility will cause you to lose sanity (This is how it works in the base game, however I changed the distance check for nearby players).

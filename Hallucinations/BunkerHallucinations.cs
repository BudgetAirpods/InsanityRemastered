...
namespace SanityRewrittenMod.Hallucinations
{
    internal class BunkerHallucinations
    {
        ...
        {
            if (SanityMainManager.MapFlow.name == "Level2Flow")
            {
                return;
            }
            if (!SanityMainManager.Instance.LightsOff)
            {
                ...
                SanitySoundManager.Instance.PlayHallucinationSound("Hallucination_Bunker_06",true);
            }
        ...
        {
            SanitySoundManager.Instance.PlayHallucinationSound();
        }
        /// <summary>
